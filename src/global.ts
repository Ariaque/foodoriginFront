...
export const incorrect_img_format = 'Une image transmise a un format incorrect';
...
export const soon_text = 'FoodOrigin se prépare au lancement vers la planète Androïd, restez à l\'affut !';
